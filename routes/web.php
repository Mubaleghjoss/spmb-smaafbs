...
Route::prefix('peserta')->name('peserta.')->middleware('cek.peserta')->group(function () {
    ...
    // Formulir SPMB
    Route::get('/formulir', [\App\Http\Controllers\Peserta\FormulirController::class, 'isi'])->name('formulir.isi');
    Route::post('/formulir', [\App\Http\Controllers\Peserta\FormulirController::class, 'simpan'])->name('formulir.simpan');
    Route::post('/formulir/submit', [\App\Http\Controllers\Peserta\FormulirController::class, 'submit'])->name('formulir.submit');
