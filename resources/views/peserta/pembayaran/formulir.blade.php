...
@section('title', 'Upload Bukti Pembayaran Formulir')
                ...
                <div class="card-body">
                    ...
                    @else
                        ...
                        <div class="alert alert-warning mb-4">
                            ...
                            <p class="mb-0"><strong>Nominal:</strong> <span class="text-success fw-bold">Rp {{ number_format($rincianBiaya['formulir'], 0, ',', '.') }}</span></p>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @php
                    ...
                    $pesanBantuan = "Assalamu'alaikum, saya *{$peserta->nama}* dengan nomor pendaftaran *{$peserta->nomor_pendaftaran}*.\n\nSaya mengalami kendala saat mengupload bukti pembayaran formulir di website SPMB. Apakah bisa dibantu untuk mengirimkan bukti pembayaran melalui WhatsApp ini?\n\nTerima kasih.";
                @endphp
