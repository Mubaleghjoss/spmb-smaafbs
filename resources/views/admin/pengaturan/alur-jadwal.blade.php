...
<style>
    ...
    .aj-title { font-weight:700; line-height:1.2; font-size:1rem; margin:0; }
    .aj-desc { font-size:.78rem; color:#64748b; line-height:1.3; margin:.15rem 0 0; }
    ...
    .aj-slot { border:1px solid #eef2f7; border-radius:.75rem; padding:.65rem .7rem; background:#fbfdff; }
    .aj-slot-title { font-size:.72rem; font-weight:700; letter-spacing:.03em; text-transform:uppercase; margin-bottom:.45rem;
    ...
    .aj-card .form-control-sm { font-size:.82rem; }
    ...
    .aj-switch .form-check-input { margin:0; cursor:pointer; }
    .aj-switch-label { font-size:.85rem; font-weight:600; margin:0; }
    .aj-picker-label { min-width:110px; }
    .gel-pill .badge { font-weight:600; }
    [x-cloak] { display:none !important; }
    @media (max-width: 575.98px){ .aj-picker-label{ min-width:100%; } }
</style>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
                <span class="text-muted small fw-semibold aj-picker-label"><i class="bi bi-calendar3 me-1"></i>Tahun Ajaran:</span>
            ...
            <div class="d-flex flex-wrap align-items-center gap-2">
                <span class="text-muted small fw-semibold aj-picker-label"><i class="bi bi-layers-half me-1"></i>Gelombang:</span>
