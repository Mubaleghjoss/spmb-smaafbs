...
<div class="container-fluid p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Verifikasi Pembayaran Formulir</h1>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('tim-spmb.verifikasi.pembayaran-formulir.terima', $p) }}" method="POST" class="d-inline">
                                    @csrf
                                ...
                                <div class="modal fade" id="tolakModal{{ $p->id }}" tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{ route('tim-spmb.verifikasi.pembayaran-formulir.tolak', $p) }}" method="POST">
                                                @csrf
